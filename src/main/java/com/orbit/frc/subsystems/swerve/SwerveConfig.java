...
import com.orbit.frc.subsystems.flywheels.FlywheelConfig;
...
public class SwerveConfig {
    ...
    */
     ...
     */
    public static SwerveSubsystem createSwerve() { 
        ...
        return new SwerveSubsystem(config); 
    }
}
